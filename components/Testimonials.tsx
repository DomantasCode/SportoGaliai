...
const Testimonials: React.FC = () => {
  return (
    <section className="py-24 bg-gray-50 dark:bg-neutralDark transition-colors duration-300">
            ...
            <div className="md:w-1/3">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 text-sm">Laimingų šeimų pasirinko mus</p>
                    </div>
                    <div className="flex items-center gap-4">
                        <span className="text-5xl font-bold text-highlight">10m.</span>
                        <p className="text-gray-600 dark:text-gray-300 text-sm">Patirties dirbant su vaikais</p>
                    </div>
                </div>
            </div>
