        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center animate-in slide-in-from-left duration-700 fade-in text-center lg:text-left pt-6 lg:pt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#contact"
                className="bg-accent text-white px-8 py-4 rounded-[2rem] font-bold text-lg hover:bg-secondary hover:text-primary transition-all shadow-xl shadow-accent/10 flex items-center justify-center gap-3 group min-w-[200px]"
              >
                Registruotis
          ...
          <div className="lg:col-span-6 relative mt-8 lg:mt-0 h-[500px] md:h-[600px] lg:h-[700px] w-full">
             <div className="absolute inset-0 flex items-center justify-center">
                 ...
                 <div className="relative w-[80%] h-[80%] md:w-[70%] md:h-[90%] z-10 transform rotate-[-2deg] hover:rotate-0 transition-transform duration-700 ease-out">
                    ...
                    <div className="w-full h-full rounded-[3rem] overflow-hidden shadow-2xl border-[6px] border-white bg-gray-200 relative">
                        ...
                        <div className="absolute bottom-8 left-8 right-8 text-white">
                            <p className="font-serif italic text-2xl">"Čia auga čempionai"</p>
                        </div>
                    </div>
                 </div>
                 ...
                 {/* Decorative Circle */}
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] border border-primary/5 rounded-full z-0 animate-spin-slow pointer-events-none dashed-border"></div>
             </div>
          </div>
