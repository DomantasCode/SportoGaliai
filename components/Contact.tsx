...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-white dark:bg-dark relative transition-colors duration-300">
      <div className="container mx-auto px-4 md:px-6 2xl:px-12 3xl:px-6">
        ...
        <div id="contact-form" className="bg-gray-50 dark:bg-neutralDark rounded-[3rem] shadow-xl overflow-hidden border border-gray-200 dark:border-white/10 mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 bg-white dark:bg-dark p-10 md:p-12 text-gray-900 dark:text-white relative overflow-hidden order-2 lg:order-1 flex flex-col justify-between border-r border-gray-200 dark:border-white/10">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-3 text-gray-900 dark:text-white">Susisiekite</h2>
                <p className="text-gray-600 dark:text-gray-400 text-lg mb-10">Esame čia, kad atsakytume į visus jūsų klausimus ir padėtume užsiregistruoti.</p>
                ...
                <div className="space-y-6">
                  <a href="tel:+37061240647" className="flex items-center gap-5 group">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-medium text-gray-900 dark:text-white group-hover:text-secondary transition-colors">+370 612 40647</p>
                    </div>
                  </a>
                  ...
                  <a href="mailto:info@sportogalia.com" className="flex items-center gap-5 group">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-medium break-all text-gray-900 dark:text-white group-hover:text-secondary transition-colors">info@sportogalia.com</p>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-5 group">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-medium text-gray-900 dark:text-white group-hover:text-secondary transition-colors">Vilnius, Lietuva</p>
                    </div>
                  </div>
                </div>
              </div>
